...
public class DrawShapes extends JPanel implements ActionListener {
    ...
    public DrawShapes() {
        ...
        // Controles de color (nuevo selector avanzado)
        controlPanel.add(new JLabel("Color:"));
        colorButton = new JButton("Seleccionar Color");
        colorButton.setBackground(currentColor);
        colorButton.setForeground(Color.WHITE);
        colorButton.addActionListener(e -> {
            ColorSelector selector = new ColorSelector((Frame)SwingUtilities.getWindowAncestor(this));
            selector.setVisible(true);
            Color newColor = selector.getSelectedColor();
            if (newColor != null) {
                currentColor = newColor;
                colorButton.setBackground(newColor);
                colorButton.setForeground(
                        (newColor.getRed() + newColor.getGreen() + newColor.getBlue()) / 3 > 128 ?
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Dibujor 2D con Selector de Color Avanzado");
...
class JavaDraw2DPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void applyBooleanOperation(String operation) {
        ...
        shapes.add(result);
        colors.add(new Color(0, 0, 255, 150));
